...
[!Different_Coordinates](../images/c_cord_vs_p_cord.png)

In the plot on the left, we represent some data using **Cartesian coordinates**,
and the task to seperate the data is not possible. In the the right, we represent the data with
**polar coordinates** and the task becomes simple to solve with a vertical line.
